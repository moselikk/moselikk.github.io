...
export interface PageOptions {
  title: string;
  type: 'about' | 'excerpt' | 'generic';
  contentHtml: string;
  url: string;
}

export function renderCustomPage(options: PageOptions): string {
  const navMeta = `
    <p class="post-meta">
      ...
      ${options.type !== 'about' ? `<a href="/about"><span><svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" style="fill: #888; margin-right: 5px; vertical-align: baseline;" viewBox="0 0 16 16"><path fill="currentColor" d="M18.333 2c1.96 0 3.56 1.537 3.662 3.472l.005.195v12.666c0 1.96-1.537 3.56-3.472 3.662l-.195.005H5.667a3.667 3.667 0 0 1-3.662-3.472L2 18.333V5.667c0-1.96 1.537-3.56 3.472-3.662L5.667 2zM6 15a1 1 0 0 0-1 1v2l.007.117A1 1 0 0 0 7 18v-2l-.007-.117A1 1 0 0 0 6 15m3-4a1 1 0 0 0-1 1v6l.007.117A1 1 0 0 0 10 18v-6l-.007-.117A1 1 0 0 0 9 11m3 2a1 1 0 0 0-1 1v4l.007.117A1 1 0 0 0 13 18v-4l-.007-.117A1 1 0 0 0 12 13"/></svg>About</span></a>` : ''}
    </p>`;

  let pageBody = options.contentHtml;
  if (options.type === 'about') {
    pageBody = `
      <div class="user-info">
        <img class="logo" style="width: 80px;" src="https://less-1251975755.cos.ap-beijing.myqcloud.com/logo-wuqu.png" alt="" />
        <div class="project">
          <a href="https://www.amiibowiki.com/">- Amiibowiki</a>
          <br />
          <a href="http://www.moselikk.com/ming-vue-temp/">- ming-vue-temp</a>
        </div> 
      </div>
      ${options.contentHtml}
    `;
  ...
  const content = `<article class="post">
    <header class="post-header">
      <h1 class="post-title" itemprop="name headline">${options.title}</h1>
      ${navMeta}
    </header>
  ...
  return renderLayout({
    title: options.title,
    canonicalUrl: `${siteConfig.url}${options.url}`,
    content
  });
}
