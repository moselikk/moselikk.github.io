...
> 原文：[https://github.com/ruanyf/document-style-guide](https://github.com/ruanyf/document-style-guide)<br>
> 作者：[ruanyf](https://github.com/ruanyf)
...
- **API**（Referenc）：[可选] [目录 or 文件] 软件 API 的逐一介绍
- **FAQ**：[可选] [文件] 常见问题解答
